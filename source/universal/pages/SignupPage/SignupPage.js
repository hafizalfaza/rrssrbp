            ...
            <div style={{width: '100%'}}>
              ...
              <form onSubmit={(e) => this.onSubmitLogin(e)}>
                <div style={{margin: '0 40px 6px'}}>
                  <input style={{width: '100%', display: 'block', fontSize: '12px', lineHeight: '18px', backgroundColor: '#fafafa'}} type="text" name="email" value={username} placeholder="Email" onChange={(e) => this.onTyping(e)}/>
                </div>
                <div style={{margin: '0 40px 6px', fontSize: '12px'}}>
                  <input style={{width: '100%', fontSize: '12px', lineHeight: '18px', backgroundColor: '#fafafa'}} type="text" name="fullName" value={password} placeholder="Full Name" onChange={(e) => this.onTyping(e)}/>
                </div>

                <div style={{margin: '0 40px 6px'}}>
                  <input style={{width: '100%', display: 'block', fontSize: '12px', lineHeight: '18px', backgroundColor: '#fafafa'}} type="text" name="username" value={username} placeholder="Username" onChange={(e) => this.onTyping(e)}/>
                </div>
                <div style={{margin: '0 40px 6px', fontSize: '12px'}}>
                  <input style={{width: '100%', fontSize: '12px', lineHeight: '18px', backgroundColor: '#fafafa'}} type="password" name="password" value={password} placeholder="Password" onChange={(e) => this.onTyping(e)}/>
                </div>

                <span style={{margin: '0 40px 22px', display: 'block', position: 'relative', backgroundColor: '#fafafa'}}>
